...
// Just implements simple inventory
public class SoulForgeRecipe implements Recipe<SimpleInventory> {
    ...
    // Constructor
    public SoulForgeRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
        this.recipeItems = recipeItems;
    }

    // This is the crafting, this defines the functionality
    @Override
    ...
    public static class Type implements RecipeType<SoulForgeRecipe> {
        ...
        public static final String ID = "soul_forge";
    }
    ...
    public static class Serializer implements RecipeSerializer<SoulForgeRecipe> {
        ...
        public SoulForgeRecipe read(Identifier id, JsonObject json) {
            ...
            return new SoulForgeRecipe(id, output, inputs);
        }
