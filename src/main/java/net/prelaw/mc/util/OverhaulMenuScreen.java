...
import net.prelaw.mc.mixin.ScreenMixin;

public class OverhaulMenuScreen extends TitleScreen {
    private static final Identifier SPLASH =
            new Identifier(MinecraftOverhaul.MOD_ID, "textures/gui/background/prelawmenu.jpg");
    ...
    private void drawComment(MatrixStack matrixStack, int width, int height) {
        drawStringWithShadow(matrixStack, this.client.textRenderer, "Thanks for installing!",
                width - this.textRenderer.getWidth("Copyright Mojang AB. Do not distribute!") - 2,
                height - 10, 0xFFFFFFFF);
    }
