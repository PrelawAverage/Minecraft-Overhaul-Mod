...
public class ModBlocks {
    ...
    public static final Block PACKED_ICE_STAIRS = registerBlock("packed_ice_stairs",
            new ModStairBlock(Blocks.ICE.getDefaultState(), FabricBlockSettings.of(Material.ICE).strength(0.5f, 0.5f).nonOpaque().slipperiness(0.98f).sounds(BlockSoundGroup.GLASS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block PACKED_CE_SLAB = registerBlock("packed_ice_slab",
            new SlabBlock(FabricBlockSettings.of(Material.WOOD).strength(0.5f, 0.5f).nonOpaque().slipperiness(0.98f).sounds(BlockSoundGroup.GLASS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block BOOKSHELF_STAIRS = registerBlock("bookshelf_stairs",
            new ModStairBlock(Blocks.ICE.getDefaultState(), FabricBlockSettings.of(Material.ICE).strength(1.5f, 1.5f).sounds(BlockSoundGroup.WOOD)), ItemGroup.BUILDING_BLOCKS);
